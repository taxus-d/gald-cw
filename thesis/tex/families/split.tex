...
\begin{figure}[htpb]
  ...
  \caption{Разбиение частиц на 3 области области на примере модели BL.
    ...
    На нижнем --- показан профиль величины $|ω_x| \approx |Ω - Ω_p|$ (в зависимости от среднего радиуса орбиты) и схематично продемонстрирован выбор радиуса коротации. Все рисунки относятся к момент времени $t=450$.
